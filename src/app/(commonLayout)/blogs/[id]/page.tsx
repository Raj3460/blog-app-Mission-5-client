...
// export const dynamicParams = false;  //! eta shadharonoto dynamic data guloe dekhao , baki gulor route cancle kore day

//* next js er export async function generateStaticParams(){} by default
//* it is mainly kisu data k static korte help kore 
...
export default async function BlogPage({
  ...
  const { data: blog } = await blogService.getBlogPostId(id);
